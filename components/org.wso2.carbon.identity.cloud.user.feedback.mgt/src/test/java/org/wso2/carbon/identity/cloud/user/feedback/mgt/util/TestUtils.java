...
public class TestUtils {
    ...
    public static final String DB_NAME = "FEEDBACK_DB";
    ...
    public static String getFilePath(String fileName) {
        ...
        if (StringUtils.isNotBlank(fileName)) {
            return Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "dbscripts", "feedback",
                    fileName).toString();
        }
    ...
    public static void mockServiceDataHolder(DataSource dataSource) {

        mockStatic(FeedbackManagementServiceDataHolder.class);
        FeedbackManagementServiceDataHolder serviceDataHolder = mock(FeedbackManagementServiceDataHolder.class);
        when(FeedbackManagementServiceDataHolder.getInstance()).thenReturn(serviceDataHolder);
        when(serviceDataHolder.getDataSource()).thenReturn(dataSource);
    }
}
