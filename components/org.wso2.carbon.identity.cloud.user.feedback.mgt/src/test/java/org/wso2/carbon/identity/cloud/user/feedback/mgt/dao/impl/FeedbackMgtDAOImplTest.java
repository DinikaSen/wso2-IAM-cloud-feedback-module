...
import static org.wso2.carbon.identity.cloud.user.feedback.mgt.util.TestUtils.*;
...
public class FeedbackMgtDAOImplTest extends PowerMockTestCase {
    ...
    public void setUp() throws Exception {
        ...
        Feedback feedback2 = new Feedback(2, "Sample message 2", "alex@wso2.com", "0113333333",
                UUID.randomUUID().toString(), new ArrayList<>(Arrays.asList("bug report", "needs improvement")));
    ...
    public void testListFeedback(String filter, int limit, int offset, String sortBy, String sortOrder, int resultSize)
        ...
        try (Connection connection = getConnection()) {
            ...
            List<Feedback> feedbackResultsList = feedbackMgtDAO.listFeedbackEntries(filter, limit, offset, sortBy, sortOrder);

            Assert.assertEquals(feedbackResultsList.size(), resultSize);
        }
    }

    @Test(expectedExceptions = FeedbackManagementClientException.class, dataProvider = "feedbackListFilterInvalidDataProvider")
    public void testListFeedbackWithException(String filter, int limit, int offset, String sortBy, String sortOrder) throws Exception {
    ...
    public void testUpdateFeedback(String message, String email, String contactNo, ArrayList<String> tags) throws Exception {
